		...
		public function QuestView(data:*/*, callback:Function*/) {
			...
			button = UIFactory.createButton(AssetManager.getEmbedSkin(skin, VSkin.STRETCH | VSkin.CONTAIN),
					{h:30, vCenter:0, hCenter:0}, new VLabel(
							data is VOQuest ? (data.line == -1? '' : '<span fontWeight="bold" color="#3333FF">[' + data.line + ']</span>') + data.qname /*+ data.maxnestinglevel*/ : (data == 0 ? 'no level, no prev' : 'level ' + data)), {vCenter:0, hCenter:0});
			button.data = data;
