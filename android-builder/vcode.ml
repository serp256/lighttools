...
Arg.parse [] (fun arg -> if !argc > 2 then failwith "vcode takes only three arguments" else ( Array.set argv !argc arg; incr argc; )) "android version code generator, usage: vcode <small|normal|large|xlarge> <ldpi|mdpi|hdpi|xhdpi|tvdpi> <etc|pvr|atc|dds>";;
