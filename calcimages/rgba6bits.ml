        ...
        (
          ...
          (
            ...
            (   
              ...
              in 
              let r = elt.color.r land (lnot 4)
              and g = elt.color.g land (lnot 4)
              and b = elt.color.b land (lnot 4) in
              let clr = { Color.Rgb.r = r; g; b } in
              let clr = { Color.Rgba.color = clr; alpha = elt.alpha } in
              setImageColor image !j !i clr;
          ...
          Images.save "output~2.png" (Some Images.Png) [] image;
