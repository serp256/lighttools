package ui.vbase {
	...
	public class ScaleSkin extends MovieClip {
		private var
			bitmapTL:DisplayObject,
			bitmapTC:DisplayObject,
			bitmapTR:DisplayObject,
			bitmapML:DisplayObject,
			bitmapMC:DisplayObject,
			bitmapMR:DisplayObject,
			bitmapBL:DisplayObject,
			bitmapBC:DisplayObject,
			bitmapBR:DisplayObject
		;
		...
		public function ScaleSkin(master:DisplayObject) {
			mouseChildren = false;
			this.master = master;
			update();
		}
